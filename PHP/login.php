...
<head>
    <title>Login at E-BookStore</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        <form action=" " method="post">
            <div class="form-group">
                ...
                <input type="email" class="form-control" name="loginmail" id="email" placeholder="Enter Email-id"
                    required style="color: black;">
            </div>
            <div class="form-group">
                <label for="pwd" style="color: aliceblue;"><b>Password:</b></label>
                <input type="password" class="form-control" id="pwd" name="loginpassword" placeholder="Enter Password"
                    required style="color: black;">
            </div>
